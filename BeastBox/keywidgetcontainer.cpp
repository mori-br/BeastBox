...
KeyWidgetContainer::KeyWidgetContainer(QWidget *parent)
    : QWidget(parent)
    , _id(0)
{
    setMinimumHeight(HEIGHT);

    setStyleSheet("QWidget { background-color: #111; color:#FFF; }");
